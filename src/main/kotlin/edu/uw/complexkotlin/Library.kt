...
//
val fizzbuzz : (IntRange) -> String = { numbersInRange: IntRange ->
    val result = numbersInRange.map{ number ->
    ...
    result.fold("") {accumulator, fizzBuzzString ->
        accumulator + fizzBuzzString
    }
}
